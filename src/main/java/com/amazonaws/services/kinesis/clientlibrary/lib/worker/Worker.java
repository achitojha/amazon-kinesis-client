...
public class Worker implements Runnable {
    ...
    public Worker(
        ...
        this(config.getApplicationName(), new V1ToV2RecordProcessorFactoryAdapter(recordProcessorFactory),
                ...
                new KinesisShardSyncer(new KinesisLeaseCleanupValidator()));
    ...
    Worker(String applicationName, IRecordProcessorFactory recordProcessorFactory, KinesisClientLibConfiguration config,
        ...
        this(applicationName, recordProcessorFactory, config, streamConfig, initialPositionInStream, parentShardPollIntervalMillis,
                ...
                shardPrioritization, Optional.empty(), Optional.empty(), DEFAULT_WORKER_STATE_CHANGE_LISTENER, new KinesisShardSyncer(new KinesisLeaseCleanupValidator()));
    }
     ...
     * @param shardSyncer
     *            shardSyncer instance used to check and create new leases
     */
    // NOTE: This has package level access solely for testing
    // CHECKSTYLE:IGNORE ParameterNumber FOR NEXT 10 LINES
    ...
    public static class Builder {
        ...
        @Setter @Accessors(fluent = true)
        private ILeaseSelector<KinesisClientLease> leaseSelector;
        ...
        /**
         * Provide a {@link com.amazonaws.services.kinesis.leases.interfaces.ILeaseSelector
         * ILeaseSelector}.
         *
         * @param leaseSelector
         *            Used to get fetch the list of leases that can be taken
         * @return A reference to this updated object so that method calls can be chained together.
         */
        public Builder leaseSelector(ILeaseSelector<KinesisClientLease> leaseSelector) {
        ...
        public Worker build() {
            ...
            if(shardSyncer == null) {
                shardSyncer = new KinesisShardSyncer(new KinesisLeaseCleanupValidator());
            }
